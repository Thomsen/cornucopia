...
public class ServiceBindStart extends Activity implements OnGlobalLayoutListener, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.i(TAG_SERVICE_VIEWWITDH, "getMeasuredWidth " + linearLayout.getMeasuredWidth());
		Log.i(TAG_SERVICE_VIEWWITDH, "getMeasuredHeight " + linearLayout.getMeasuredHeight());
	...
	protected void onStart() {
		super.onStart();
		intent = new Intent(ServiceBindStart.this, ServiceLifecycle.class);
	}
